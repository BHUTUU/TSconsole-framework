#!/bin/python2
import hashlib
#import sha384 # as always this is too a shit!!
import time
import sys
import getopt
sha38_hash = None
...
#sha38_hash = raw_input("\033[1;35mEnter your hash code here==> \033[0m")
#print "\n"
...
for password in pwdfile:
    hash_obj = hashlib.sha384(password.strip())
    filesha38 = (hash_obj.hexdigest())
